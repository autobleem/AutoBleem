...
${OBJECTDIR}/src/code/database.o: src/code/database.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/code/database.o src/code/database.c

${OBJECTDIR}/src/code/filesystem.o: src/code/filesystem.c
	${MKDIR} -p ${OBJECTDIR}/src/code
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/code/filesystem.o src/code/filesystem.c

${OBJECTDIR}/src/code/main.o: src/code/main.c
	${MKDIR} -p ${OBJECTDIR}/src/code
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/code/main.o src/code/main.c

${OBJECTDIR}/src/code/sqlite3.o: src/code/sqlite3.c
	${MKDIR} -p ${OBJECTDIR}/src/code
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/code/sqlite3.o src/code/sqlite3.c
