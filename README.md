## IMPORTANT NOTE: We found some people are trying to SELL AutoBleem builds on EBAY !!! AutoBleem was free, is free and will always be free. We gave no right to any third party to sell it, or to make any commercial use of this software. All those builds are illegal, they are voiding our trademark (using our logo and parts of this document), containing illegal game content and/or low quality USB drives... If you bought AutoBleem in any place please report this to us and we will progress with ebay to report the fraud. Also we will NOT SUPPORT any build bought on ebay as we are not a vendor on those builds !! We are going to support only official releases DOWNLOADED from this Github page, the excemption from this rule only is case of free (unpaid) builds created by our trusted partners.
