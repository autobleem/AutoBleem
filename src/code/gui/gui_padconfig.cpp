    ...
    */
    ...
    if (step > 9) {
        if (step == 10) {
            ...
            // this is to throw away any spurious SDL_JOYHATMOTION or SDL_JOYAXISMOTION events that are being
            // generated by some controllers before we get to press anything
            Uint32 ticks_start = SDL_GetTicks();
            SDL_Event e;
            while ((Sint32)(SDL_GetTicks() - ticks_start) < 50)
                SDL_PollEvent(&e);
        }
        gui->renderTextLine(
